...
export const closure4333_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure4340_externref_shim: (a: number, b: number, c: any, d: any) => void;
...
export const closure92627_externref_shim: (a: number, b: number, c: any) => void;
export const closure100539_externref_shim: (a: number, b: number, c: any) => void;

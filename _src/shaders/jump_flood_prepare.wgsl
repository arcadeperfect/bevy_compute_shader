...
// If any have a different value, we are an edge
...
//     // this method results in double thickness edges because 2 adjacent texels will both report an edge
...
//     // this method results in single thickness edges
...
//     // // white for edges, otherwise black
//     // // input_grid.floats[x][y][buffer_index] = result;


//     // // for the jump flood algorithm, we want 0 for edges otherwise a high value
//     // input_grid.floats[x][y][buffer_index] = (1 - result) * 10000; 
    
//     // if(x == 0 && y == 0){
//     //     input_grid.ints[0][0][0] = 521;
//     // }
// }
    ...
    egui::SidePanel::left("control_panel")
        ...
        .show(contexts.ctx_mut(), |ui| {
            ...
            ui.group(|ui| {
                ...
                ui.add(egui::Slider::new(&mut old_params.noise_amplitude, 0.0..=5.).text("amplitude"));
                ui.add(egui::Slider::new(&mut old_params.noise_freq, 0.0..=1.).text("frequency"));
                ui.add(egui::Slider::new(&mut old_params.noise_offset, 0.0..=20.).text("offset"));
                ui.add(egui::Slider::new(&mut old_params.noise_octaves, 1..=20).text("octaves"));
                ui.add(
                    egui::Slider::new(&mut old_params.noise_lacunarity, 0.0..=4.).text("lacunarity"),
                );
                ...
                ui.add(egui::Slider::new(&mut old_params.noise_weight, 0.0..=1.).text("noise weight"));
                ...
                ui.add(
                    egui::Slider::new(&mut old_params.ca_search_radius, 0.1..=6.).text("search radius"),
                );
                ui.add(egui::Slider::new(&mut old_params.ca_edge_pow, 0.1..=6.).text("edge pow"));
                ui.add(egui::Slider::new(&mut old_params.edge_suppress_mix, 0.0..=1.).text("edge mix"));
                ui.add(
                ...
                ui.add(egui::Slider::new(&mut old_params.misc_f, 0.0..=3.).text("misc f"));
